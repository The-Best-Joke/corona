...
possible_origins_cases.to_csv("../covid-in-colombia/data/possible_origins_cases.csv")
total_cases_per_day.to_csv("../covid-in-colombia/data/total_cases_per_day.csv")
total_deaths_per_day.to_csv("../covid-in-colombia/data/total_deaths_per_day.csv")
countries_cases_progression.to_csv("../covid-in-colombia/data/countries_progression.csv")
countries_deaths_progression.to_csv("../covid-in-colombia/data/countries_death_progression.csv")
###